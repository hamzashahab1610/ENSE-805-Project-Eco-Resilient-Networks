...
nodes_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Small Scale", header=1, nrows=4
)
switches_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Small Scale", header=8, nrows=4
)
physical_links_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Small Scale", header=15, nrows=8
)
sfc1_vnf_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Small Scale", header=26, nrows=3
)
sfc1_vlink_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Small Scale", header=32, nrows=2
)
...
system = System.System("system1", [sfc1], nodes, switches, physical_links, 24, 0.6)
