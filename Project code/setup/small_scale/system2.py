...
nodes_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Experiment 2", header=1, nrows=12
)
switches_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Experiment 2", header=16, nrows=14
)
physical_links_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Experiment 2", header=33, nrows=36
)
sfc1_vnf_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Experiment 2", header=72, nrows=6
)
sfc1_vlink_df = pd.read_excel(
    "Experiments.xlsx", sheet_name="Experiment 2", header=81, nrows=6
)
...
system = System.System("system2", [sfc1], nodes, switches, physical_links, 24, 0.5)
